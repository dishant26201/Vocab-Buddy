...
import com.dishant26201.wordquiz.databinding.ActivityDictionaryBinding
...
class DictionaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnGo.setOnClickListener {
            if (binding.etWord.text.toString().isEmpty()) {
                ...
                word = binding.etWord.text.toString().lowercase()
                findMeaningDictionary(word)
            }
        }
    }
    ...
    private fun createPopUpDictionary(popUpView : View?, audioUrl : String?, wordX: String, meaningYes : Boolean) {
        ...
        binding.btnGo.isClickable = true
    }
